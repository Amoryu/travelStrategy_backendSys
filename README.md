# travelStrategy Backend System

### 介绍 📖

travelStrategy Backend System是基于 Vue3.2、TypeScript、Vite3、Pinia、Element-Plus 的后台管理框架，封装了一些常用组件、Hooks、指令、动态路由、按钮级别权限控制等功能。

### 项目前台及服务器代码仓库🧩

项目后台接口完全采用 Mock 数据，感谢以下 Mock 平台支持：

- 微信小程序：https://github.com/Amoryu/travelStrategy_uniapp.git
- 后台服务器：https://github.com/Amoryu/travelStrategyServer
